...
export const mbtiQuestions: mbtiQuestions = [
    ...
    { question: 'how clean is your room? (if you have one lol)', options: [{ value: 'clean as fuck', score: -12 }, { value: 'its clean', score: -6 }, { value: 'its messy', score: 6 }, { value: 'i live like a dog', score: 12 }], questionType: 'jp' },
    ...
    { question: 'How likely are you to prefer a quiet weekend alone over a social event?', options: [{ value: 'I definitely prefer alone time.', score: -12 }, { value: 'I usually prefer alone time.', score: -6 }, { value: 'I might prefer alone time.', score: 6 }, { value: 'I dont prefer alone time.', score: 12 }], questionType: 'ie' },
    { question: "How likely are you to rely on imagination over concrete facts when solving problems?", options: [{ value: 'I definitely rely on imagination', score: -12 }, { value: 'I usually rely on imagination', score: -6 }, { value: 'I might rely on imagination', score: 6 }, { value: 'I dont rely on imagination', score: 12 }], questionType: 'ns' },
    { question: 'How likely are you to make decisions based on empathy rather than objective analysis?', options: [{ value: 'I definitely base decisions on empathy', score: -12 }, { value: 'I usually base decisions on empathy', score: -6 }, { value: 'I might base decisions on empathy', score: 6 }, { value: 'I dont base decisions on empathy.', score: 12 }], questionType: 'ft' },
    { question: 'How likely are you to prefer spontaneous plans over well-structured plans?', options: [{ value: 'I dont prefer spontaneous plans', score: -12 }, { value: 'I might prefer spontaneous plans', score: -6 }, { value: 'I usually prefer spontaneous plans', score: 6 }, { value: 'I definitely prefer spontaneous plans', score: 12 }], questionType: 'jp' },
]
