...
export const mbtiQuestions: mbtiQuestions = [
    ...
    { question: "how much do you think about your crush (if you have one, or when you had one)?", options: [{ value: "I overthink", score: -12 }, { value: "I think a lot", score: -6 }, { value: "I rarely think", score: 6 }, { value: "I don't care", score: 12 }], questionType: "ft" },
    { question: "are you on time on different events and classes?", options: [{ value: "Yes, always", score: -12 }, { value: "Yes, usually", score: -6 }, { value: "No, not often", score: 6 }, { value: "Never", score: 12 }], questionType: "jp" },

    { question: "how difficult is it for you to make friends?", options: [{ value: "Very difficult", score: -12 }, { value: "it might bother me", score: -6 }, { value: "not that difficult", score: 6 }, { value: "Really easy", score: 12 }], questionType: "ie" },
    { question: "Do you like to live in an old castle with a giant dragon?", options: [{ value: "absolutely", score: -12 }, { value: "probably", score: -6 }, { value: "I don't think so", score: 6 }, { value: "definitely not", score: 12 }], questionType: "ns" },
    ...
    { question: "there's a big party at your friend's house, would you like to get there?", options: [{ value: "definitely not", score: -12 }, { value: "I don't think so", score: -6 }, { value: "I might go", score: 6 }, { value: "of course", score: 12 }], questionType: "ie" },
    { question: "if you should take a path and you \"feel\" like it's wrong, would you take that path?", options: [{ value: "Definitely not", score: -12 }, { value: "I probably won't", score: -6 }, { value: "I think I will", score: 6 }, { value: "I will", score: 12 }], questionType: "ns" },
    { question: "how good are you at understanding people's emotions?", options: [{ value: "very good", score: -12 }, { value: "I understand them", score: -6 }, { value: "Not really", score: 6 }, { value: "Not at all", score: 12 }], questionType: "ft" },
    { question: "you have an important exam tomorrow, when will you start studying?", options: [{ value: "right now", score: -12 }, { value: "in an hour or two", score: -6 }, { value: "probably at night", score: 6 }, { value: "tomorrow", score: 12 }], questionType: "jp" },
